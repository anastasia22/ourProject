...
function homeTemplate() {
    ...
    str += '<div id="News">';
    str += '<div class="singleNewsBlock"><img class="newsPic" src="' + MarkHamill.picture + '">';
    str += '<div class="newsInfo"><h2 class="newsHeader">' + MarkHamill.header + '</h1>' +
    '<div class="newsArticle"><p>' + MarkHamill.article + '</p></div></div>';
    ...
    str += '<div class="singleNewsBlock"><img class="newsPic" src="' + NataliePortman.picture + '">';
    str += '<div class="newsInfo"><h2 class="newsHeader">' + NataliePortman.header + '</h1>' +
    '<p class="newsArticle">' + NataliePortman.article + '</p></div>';
